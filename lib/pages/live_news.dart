...
class _LiveNewsState extends StateMVC {
  ...
  _LiveNewsState() : super(ELiveNewsController()) {
    eLiveNewsController = ELiveNewsController() as ELiveNewsController;
  }
  int? selectedVideo;
  ...
  setVideo() {
    final videoId = convert.YoutubePlayer.convertUrlToId(
      eLiveNewsController!.liveNewsModel![selectedVideo!.toInt()].url.toString(),
    );
                ...
                selectedVideo == null
                    ...
                    : Container(
                        ...
                        child: Row(
                          children: [
                            Image.network(
                              '${Urls.baseServer}upload/company-logo/original/' +
                                  eLiveNewsController!
                                      .liveNewsModel![selectedVideo!.toInt()].image.toString(),
                              height: 50,
                              width: 50,
                              fit: BoxFit.cover,
                            ),
                            ...
                            Text(
                              eLiveNewsController!
                                  .liveNewsModel![selectedVideo!.toInt()].companyName.toString(),
                              style: TextStyle(
                                  color: appThemeModel
                          ...
                          child: Row(
                            children: [
                              Image.network(
                                '${Urls.baseServer}upload/company-logo/original/' +
                                    eLiveNewsController!
                                        .liveNewsModel![index].image.toString(),
                                height: 75,
                                width: 75,
                                fit: BoxFit.cover,
                              ),
                              Expanded(
                                child: Center(
                                  child: Text(
                                    eLiveNewsController!
                                        .liveNewsModel![index].companyName.toString(),
                                    style: TextStyle(
                                        color: appThemeModel
                                                .value.isDarkModeEnabled.value
                                            ? Colors.white
