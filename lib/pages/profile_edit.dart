...
import 'package:blog_app/pages/device_info.dart';
import 'package:blog_app/pages/useful_elements.dart';
...
import 'package:blog_app/pages/toast_component.dart';
import 'package:toast/toast.dart';
import 'package:blog_app/pages/input_decorations.dart';
import 'package:blog_app/repository/profile_repository.dart';
import 'package:image_picker/image_picker.dart';
import 'package:permission_handler/permission_handler.dart';
import 'package:flutter/cupertino.dart';
import 'package:blog_app/helpers/file_helper.dart';
...
class _ProfileEditState extends State<ProfileEdit> {
    ...
    if (status.isDenied) {
      ...
      showDialog(
          ...
          builder: (BuildContext context) => CupertinoAlertDialog(
                title: Text("common_photo_permission"),
                content: Text("common_app_needs_permission"),
                actions: <Widget>[
                  CupertinoDialogAction(
                    child: Text("common_deny"),
                    onPressed: () => Navigator.of(context).pop(),
                  ),
                  CupertinoDialogAction(
                    child: Text("common_settings"),
                    onPressed: () => openAppSettings(),
                  ),
                ],
              ));
    } else if (status.isRestricted) {
      ToastComponent.showDialog("common_give_photo_permission",
      ...
      if (_file == null) {
        ToastComponent.showDialog("common_no_file_chosen",
            gravity: Toast.center, duration: Toast.lengthLong);
        return;
      }
  ...
  onPressUpdate() async {
    ...
    if (name == "") {
      ToastComponent.showDialog("profile_edit_screen_name_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    if (phone == "") {
      ToastComponent.showDialog("profile_edit_screen_phone_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  onPressUpdatePassword() async {
    ...
    if (!change_password && password == "") {
      ToastComponent.showDialog("profile_edit_screen_password_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    if (!change_password && password_confirm == "") {
      ToastComponent.showDialog("profile_edit_screen_password_confirm_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    if (change_password && password.length < 6) {
      ToastComponent.showDialog("password_otp_screen_password_length_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    if (change_password && password != password_confirm) {
      ToastComponent.showDialog("profile_edit_screen_password_match_warning",
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        "profile_edit_screen_edit_profile",
        style: TextStyle(
            fontSize: 16,
  ...
  buildBody(context) {
    if (is_logged_in.$ == false) {
      return Container(
          ...
          child: Center(
              child: Text(
            "profile_edit_screen_login_warning",
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Center(
            child: Text(
              "local.profile_edit_screen_password_changes",
              style: TextStyle(
