...
import 'package:blog_app/repository/chat_repository.dart';
...
class Chat extends StatefulWidget {
  Chat({
    ...
    required this.messenger_name,
    required this.messenger_title,
    required this.messenger_image,
  }) : super(key: key);
...
class _ChatState extends State<Chat> {
    ...
    return Container(
      ...
      child: Center(
        child: Text(_totalData == _list.length
            ? "common_no_more_items"
            : "common_loading_more_items"),
      ),
    );
  }
  ...
  buildChatList() {
    if (_isInitial && _list.length == 0) {
      ...
      return Center(child: Text("common_no_data_available"));
    } else {
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: "chat_screen_type_message_here",
                hintStyle:
  ...
  Container smsContainer(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(width: 1, color: MyTheme.textfield_grey),
